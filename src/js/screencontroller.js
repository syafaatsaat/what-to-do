class DialogManager {
  ...
  openProjectModal() {
    ...
    document.querySelector("#project-form-header").textContent = "New Project";
  ...
  openProjectModalForEdit(project) {
    ...
    document.querySelector("#project-form-header").textContent = "Edit Project";
...
export class ScreenController {
  ...
  init() {
    if (!this.logic.storage.vault) return;
  ...
  projectSubmitHandler(e) {
    ...
    if (formData.projectID) {
      // edit project
      if (!this.logic.editProject(formData.projectID, formData)) return;
  ...
  deleteProjectHandler(e) {
    ...
    if (!this.logic.deleteProject(project.id)) return;

    if (!this.renderer.removeProjectView(project)) return;
  ...
  taskSubmitHandler(e) {
    ...
    // edit
    if (formData.taskID) {
      if (!this.logic.editTask(projectID, formData.taskID, formData)) return;
  ...
  deleteTaskHandler(e) {
    ...
    if (!this.logic.deleteTask(projectID, taskID)) return;
